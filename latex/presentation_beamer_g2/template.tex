%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  LaTeX Template for Beamer Presentation
%
%%%%%%%%%%%%%%%%%
% Changelog
% Version 2.1 (March 18, 2023; Zakeri):
%% Add support to metropolis theme
%% Add package metropolis_framesubtitle
%
% Version 2.0 (March 8, 2022; Vel)
%
%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%
% Author:
% Edition 2.0 by Vel (vel@latextemplates.com) 
%%
% Editition 2.1 by: Morteza Zakeri (m-zakeri@live.com)
%
%%%%%%%%%%%%%%%%%
% License:
...
\begin{frame}
	...
	\framesubtitle{Subtitle X} % Optional subtitle
