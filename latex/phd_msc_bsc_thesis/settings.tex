...
}
{
	...
	\usepackage[unicode=true, pagebackref=false, colorlinks, linkcolor=Blue, citecolor=LimeGreen, urlcolor=FireBrick, bookmarks=true, linktocpage, breaklinks]{hyperref}
...
\chapterfont{\color{DodgerBlue4}  \Huge \raggedleft}  % sets colour of chapters
\sectionfont{\color{DeepSkyBlue4}}  % sets colour of sections
\subsectionfont{\color{DeepSkyBlue3}}  % sets colour of sections

\captionsetup[figure]{labelfont={color=Brown4, bf}} %DarkStateGray
\captionsetup[table]{labelfont={color=Brown4, bf}} %DarkStateGray
...
%%%PDF setting
\usepackage[open, openlevel=1, atend]{bookmark}[2019/10/31]
